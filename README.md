...
- **Web search**—scoped to your community's domains via `SEARCH_DOMAINS`
...
Set your Morpheus API key to enable AI features:

```bash
# Get your key at https://app.mor.org
...
| AI model        | `AI_MODEL` env var                                        | Defaults to `glm-5`; see [available models](https://apidocs.mor.org/documentation/models) |
...
- [AI SDK 6](https://ai-sdk.dev)—AI model integration
- [Morpheus Inference API](https://apidocs.mor.org)—decentralized AI inference
