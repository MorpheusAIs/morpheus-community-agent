...
export const mockActions: BotAction[] = [
  ...
  },
  {
    ...
    channel: '#bugs',
    user: 'emma.davis',
    description: 'Confirmed a reported CSS rendering issue and linked to the fix PR',
  ...
  },
  {
    ...
    channel: '#help',
    user: 'james.wright',
    description: 'Explained the difference between Chat SDK subscriptions and polling',
  ...
  },
  {
    ...
    channel: '#help',
    user: 'ethan.brown',
    description: 'Answered question about AI SDK tool definitions and parameters',
  ...
  },
  {
    ...
    type: 'flagged',
    channel: 'DM',
    description: 'Flagged issue to community lead: User reporting harassment in DMs',
...
export const mockConversations: Record<string, ConversationMessage[]> = {
  ...
  'mock-21': [
    {
      role: 'user',
      content: 'What happens if a workflow step fails? Does it retry the whole thing?',
      timestamp: daysAgo(3, 3),
    },
    {
      role: 'assistant',
