...
| Web search        | `@Community Agent what's the latest on Next.js 16 caching?`                                         | "Next.js 16 introduces significant updates..." (searches via Claude's native web search, scoped to `SEARCH_DOMAINS`, logged as **answered**)                                          |
